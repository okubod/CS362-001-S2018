   ...
   /**
     ...
     */
	 @Test
	  public void radnomtest()  throws Throwable  {
		 ...
		 System.out.println("Start testing of Appt...");
	...
	//			System.out.println(" Seed:"+randomseed );
				Random random = new Random(randomseed);
				 ...
				 if(iteration == 0){
					 appt = new Appt(startHour, startMinute, startDay, startMonth, -1, title, description, emailAddress);
				 }
				 appt.setValid();
					...
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("setTitle")){
						...
						/*else if(methodName.equals("isOn")){
							int thisDay=ValuesGenerator.getRandomIntBetween(random, 0, 32);
							int thisMonth=ValuesGenerator.getRandomIntBetween(random, 0, 12);
							int thisYear=ValuesGenerator.getRandomIntBetween(random, 2018, 2018);
							appt.isOn(thisDay, thisMonth, thisYear);
						}*/
						int thisDay=ValuesGenerator.getRandomIntBetween(random, 0, 32);
						int thisMonth=ValuesGenerator.getRandomIntBetween(random, 0, 12);
						int thisYear=ValuesGenerator.getRandomIntBetween(random, 2018, 2018);
